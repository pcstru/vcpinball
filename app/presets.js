(function initPresets(Pin) {
    ...
    Pin.presets.cyberpin = {
        ...
        elements: [
            ...
            { id: "lf", type: "flipper", side: "left", control: "left", pivot: { x: 135, y: 685 }, length: 95, restAngle: 0.55, activeAngle: -0.55, flipSpeed: 24, flipAccel: 220, returnSpeed: 18, returnAccel: 160, strikeBoost: 0.52, tipStrikeBoost: 0.68, surfaceRestitution: 0.28, surfaceFriction: 0.08, tipRestitution: 0.38, tipFriction: 0.04, thickness: 10, color: "#00ddff" },
            { id: "rf", type: "flipper", side: "right", control: "right", pivot: { x: 365, y: 685 }, length: 95, restAngle: 2.5915926535, activeAngle: 3.6915926535, flipSpeed: 24, flipAccel: 220, returnSpeed: 18, returnAccel: 160, strikeBoost: 0.52, tipStrikeBoost: 0.68, surfaceRestitution: 0.28, surfaceFriction: 0.08, tipRestitution: 0.38, tipFriction: 0.04, thickness: 10, color: "#ff4466" },
